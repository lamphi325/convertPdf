    ...
    public class ConvertPdf : IConvertPdf
    {
        ...
        public void Convert4()
        {
            string html = @"
                ...
                <body style=""margin: 0; padding: 0; width: 892px; height: 1448px; background-image: url(D:\\inetpub\\ConvertPdf\\ConvertPdf\\wwwroot\\image\\target001.png); background-repeat: no-repeat; background-size: cover; object-fit: fill;"">
            ...
            //config.PageSize = PdfSharp.PageSize.B4;
            //PdfSharp.Pdf.PdfDocument pdfDocument = PdfGenerator.GeneratePdf(html, config);
